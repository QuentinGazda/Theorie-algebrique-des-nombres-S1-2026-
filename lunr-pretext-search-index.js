...
},
{
  ...
  "body": " Théorie des réseaux  Nous rappelons ici quelques définitions et résultats de base sur les réseaux dans les espaces euclidiens qui seront utilisés dans ce cours.  Soit un espace vectoriel réel de dimension finie muni d'une norme fixée quelconque notée .    Un réseau dans est un sous-groupe discret Cela signifie que pour tout compact , l'intersection est finie. Il suffit de vérifier cette condition pour les , les boules de rayon . de qui contient une base.       Le groupe est un exemple de réseau dans .    Le sous-groupe est un réseau dans . En effet il est discret (car inclus dans ) et contient une base, par exemple .     Les réseaux sont des groupes abéliens libres.   Base d'un réseau   Soit un réseau de . Alors contient une base de qui est aussi une famille génératrice.     Étant donnée une base de , on note le sous-groupe de engendré par cette base, à savoir:)   C'est un réseau car il contient la base et est discret: si désigne la norme sup dans cette base, alors   qui est un ensemble fini.   "
},
{
  "id": "def-reseau",
  "level": "2",
  ...
  "number": "A.3.1",
  "title": "",
  "body": "  Un réseau dans est un sous-groupe discret Cela signifie que pour tout compact , l'intersection est finie. Il suffit de vérifier cette condition pour les , les boules de rayon . de qui contient une base.   "
},
{
  "id": "sec-reseaux-5",
  "level": "2",
...
},
{
  ...
  "number": "A.3.1",
  "title": "",
  "body": " Étant donnée une base de , on note le sous-groupe de engendré par cette base, à savoir:)   C'est un réseau car il contient la base et est discret: si désigne la norme sup dans cette base, alors   qui est un ensemble fini.  "
},
{
  "id": "references",
  "level": "1",
