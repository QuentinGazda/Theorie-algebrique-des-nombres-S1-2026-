...
},
{
  ...
  "body": " Formule du nombre de classes   La fonction converge uniformément vers une fonction holomorphe sur le demi-plan et s'étend méromorphiquement au demi-plan avec un pôle simple en . Son résidu se calcule par la formule :   où est le nombre de classes de , son régulateur, désigne le nombre de racines de l'unité de et son discriminant.   "
},
{
...
},
{
  ...
  "number": "5.3.7",
  "title": "",
  "body": " Si est un caractère de Dirichlet réel modulo impair ( c-à-d  ), alors il existe une formule close pour :   Combiné à la formule du nombre de classes, elle permet de calculer le cardinal du groupe de classes lorsque est un corps quadratique imaginaire de discriminant . On a alors :   "
},
{
