...
},
{
  ...
  "number": "3.1.1",
  "title": "",
  "body": " On commence par énoncer deux lemmes qui, ensembles, garantissent que contient une base de .    Soit une base de en tant que -espace vectoriel. Alors est une -base de qui engendre un réseau de covolume .     On rappelle que le covolume de la famille dans l'espace est donné par la valeur absolue du déterminant de la matrice de changement de base entre et la base canonique de ( cf.  ). Pour , la ième coordonnée s'écrit dans la base canonique comme   Cela montre que le covolume est donné par la valeur absolue du déterminant de la matrice   En multipliant à droite cette matrice par la matrice complexe de taille donnée par   on trouve la matrice   qui n'est autre que la matrice dont le carré du déterminant est égal à . Le déterminant de la matrice réelle initiale est donc égal à une racine du discriminant divisé par , le déterminant de la matrice complexe . La valeur absolue, et donc le covolume, s'en déduit.      contient une base de en tant que -espace vectoriel.     Soit une base de en tant que -espace vectoriel. Pour chaque , il existe un entier non nul tel que ( ). Ainsi est encore une base de comme -espace vectoriel et est contenue dans .   D'après le , il reste à montrer que l'image est discrète dans . On équippe alors de la norme sup dans la base canonique.  Pour et , l'inégalité signifie que pour et que et pour . En particulier, pour tout .  De l'identité   ( ), on déduit que le -ième coefficient de vérifie   Puisqu'il n'y a qu'un nombre fini de polynômes à coefficients entiers vérifiant ces inégalités, il n'y a qu'un nombre fini de possibles, et donc qu'un nombre fini de tels (racine de ). Ainsi, est discret dans .  "
},
{
  "id": "sec-OK-25",
  "level": "2",
...
},
{
  ...
  "body": " Discriminant d'un corps de nombres   Le discriminant de est le discriminant d'une base de en tant que -module. On le note , ou même .   "
},
{
...
{
  "id": "prop-covolume-sigmaOK",
  "level": "2",
  "url": "sec-discriminant-de-K.html#prop-covolume-sigmaOK",
  "type": "Proposition",
  "number": "3.2.3",
  "title": "",
  "body": "  Le réseau est de covolume .   "
},
{
  "id": "sec-discriminant-de-K-7",
  "level": "2",
  "url": "sec-discriminant-de-K.html#sec-discriminant-de-K-7",
  "type": "Remarque",
  "number": "3.2.4",
  "title": "",
...
},
{
  ...
  "body": " Discriminant d'un sous-groupe de   Soit un sous-groupe contenant une base de La même preuve que celle du montre que est un réseau de . En particulier, on notera que est libre de rang en tant que -module. . Le discriminant de est le discriminant d'une base de en tant que -module. On le note .   "
},
{
...
{
  "id": "exemple-nombre-plastique",
  "level": "2",
  "url": "sec-discriminant-de-K.html#exemple-nombre-plastique",
  "type": "Exemple",
  "number": "3.2.7",
...
{
  "id": "lem-inclusion-ideaux-normes",
  "level": "2",
...
},
{
  ...
  "number": "3.3.2",
  "title": "",
  "body": " On dispose d'une application surjective entre groupes finis de noyau . On conclut par le théorème de Lagrange.  "
},
{
  "id": "thm-minkowski",
  "level": "2",
...
},
{
  ...
  "body": " Groupe des classes d'idéaux  On se pose maintenant la question de savoir si l'anneau est principal. Nous verrons que ce n'est pas toujours le cas, et le défaut de principalité est mésuré par un groupe abélien fini appelé le groupe des classes d'idéaux de .    Soit un anneau intègre et notons son corps de fractions.  Deux idéaux non nuls et de sont dits équivalents , et on note alors , s'il existe deux éléments tels que .  On désigne par l'ensemble des classes d'idéaux non nuls de à équivalence près. On notera par la classe d'un idéal non nul .    On note la classe de l'idéal principal . La pertinence de cette notion d'équivalence vient de la proposition suivante :    Un idéal non nul est principal si, et seulement si . En particulier, est principal si, et seulement si, est réduit à un élément.     Si est principal, disons , alors et donc .  Si , alors il existe tels que , soit . En particulier et donc et .   Soient deux ideaux non nuls de . Rappelons que l'on écrit pour désigner l'idéal :   Cette opération est commutative (on a en effet ) et associative (on a ).  On notera par ailleurs que si est un idéal premier, alors implique que ou ; si ce n'était pas le cas, on pourrait trouver et tels que , ce qui contredirait la primalité de .    Le produit des idéaux induit une loi de composition commutative et associative sur dont l'élément neutre est .     Soient des idéaux non nuls. Si et , alors il existe tels que et . En multipliant ces égalités, on trouve , soit . Par conséquent, la loi de composition induite par le produit d'idéaux sur les classes d'idéaux est bien définie. De plus, elle est commutative et associative car le produit d'idéaux l'est.   Ce qui manque à pour être un groupe est l'existence d'inverses. Remarquons qu'un idéal est tel que est inversible dans si, et seulement si, il existe un idéal tel que est principal. Nous dirons alors que est inversible .   On note généralement le goupe obtenu comme le sous-ensemble de formé des classes inversibles. C'est le groupe de Picard de .   Soit un corps de nombres. Nous allons montrer deux théorèmes fondamentaux : d'abord que est fini, puis que c'est un groupe.   Finitude du nombre de classes    est un ensemble fini.     Soit la partie entière de où est la constante de Minkowski ( cf.  ). Nous allons montrer que tout idéal non nul de est équivalent à un idéal contenant l'un des entiers et qu'il n'y a qu'un nombre fini d'idéaux de contenant un entier donné.  Soit un idéal non nul de . D'après le , il existe tel que . Par Lagrange, . On a donc   En posant , on trouve que et que contient l'entier .  Il reste à montrer qu'il n'y a qu'un nombre fini d'idéaux contenant . Mais ces idéaux sont en bijection avec les idéaux de qui est un anneau fini à éléments.     est principal  Soit un corps de nombres. Soit la constante . Si , alors et la preuve du impose que tout idéal de est équivalent à un idéal contenant , soit à un idéal principal. En conséquence, est réduit à un élément et est principal.  Ce fait s'applique, par exemple, aux quelques corps de nombre suivants , , , , , (mais pas par exemple) , mais aussi à certains corps de nombres de degré tel que le corps plastique ( cf. ). En particulier, leur anneau d'entiers, à savoir :   sont principaux.    Les corps de nombres de nombre de classe , c-à-d ceux pour lesquels , restent très mystérieux. Le théorème de Stark-Heegner énonce que si est sans facteur carré, alors est de nombre de classe si, et seulement si   Une conjecture de Gauss, toujours ouverte, stipule qu'il existe une infinité de sans facteur carré tel que ait nombre de classe   Plus modestement, on ne sait même pas s'il existe une infinité de corps de nombres de nombre de classe . Celui de plus grand degré observé ayant cette propriété est de degré (voir l'article de ).     Soit un corps de nombres. Alors tout idéal non nul de est inversible; autrement dit, est un groupe abélien fini.     On commence par montrer que la multiplication des idéaux est simplifiable dans un sens faible :    Si sont deux idéaux non nuls de tels que pour un certain , alors .     Nous allons d'abord montrer comment ramener le problème au cas où .  Pour cela, montrons que . Soit , de sorte que .On sait que est un -module libre de rang fini, et si l'on fixe une base de , alors l'élément agit par multiplication sur cette base comme une matrice à coefficients entiers. Par Cayley-Hamilton, le polynôme caractéristique de cette matrice annule , et comme ses coefficients sont entiers, on en déduit que . Par conséquent, .  Soit alors . On a alors , et le lemme de Nakayama ( e.g.  ) permet de conclure que , soit .   Soit un idéal non nul de . Pour montrer qu'il est inversible, il suffit de montrer qu'il existe un entier tel que est principal (car alors la classe de est l'inverse de la classe de ). Comme est fini, il existe deux entiers tels que . Il existe alors des éléments tels que et donc . En appliquant le , on trouve puis que est principal d'après la .     Soient trois idéaux non nuls de .    (Simplification) Si , alors .    (Contenir c'est diviser) Si , alors il existe un idéal tel que .       Pour démontrer la simplification, prenons un idéal de tel que soit un principal, mettons (l'existence de est assurée par le ). Alors   soit : , à savoir .  De même, soit et tels que . Posons . C'est bien un idéal de car . On vérifie alors que .   "
},
{
  "id": "def-classe",
  "level": "2",
...
},
{
  ...
  "number": "3.4.1",
  "title": "",
  "body": " Si est principal, disons , alors et donc .  Si , alors il existe tels que , soit . En particulier et donc et .  "
},
{
...
{
  "id": "sec-groupe-des-classes-12",
  "level": "2",
  "url": "sec-groupe-des-classes.html#sec-groupe-des-classes-12",
  "type": "Démonstration",
  "number": "3.4.2",
  "title": "",
...
{
  "id": "sec-groupe-des-classes-14",
  "level": "2",
  "url": "sec-groupe-des-classes.html#sec-groupe-des-classes-14",
  "type": "Remarque",
  "number": "3.4.4",
  "title": "",
  "body": " On note généralement le goupe obtenu comme le sous-ensemble de formé des classes inversibles. C'est le groupe de Picard de .  "
},
{
...
{
  "id": "sec-groupe-des-classes-18",
  "level": "2",
  "url": "sec-groupe-des-classes.html#sec-groupe-des-classes-18",
  "type": "Exemple",
  "number": "3.4.6",
  "title": "<span class=\"process-math\">\\(\\mathbb{Z}[\\zeta_3]\\)<\/span> est principal.",
  "body": "  est principal  Soit un corps de nombres. Soit la constante . Si , alors et la preuve du impose que tout idéal de est équivalent à un idéal contenant , soit à un idéal principal. En conséquence, est réduit à un élément et est principal.  Ce fait s'applique, par exemple, aux quelques corps de nombre suivants , , , , , (mais pas par exemple) , mais aussi à certains corps de nombres de degré tel que le corps plastique ( cf. ). En particulier, leur anneau d'entiers, à savoir :   sont principaux.  "
},
{
  "id": "sec-groupe-des-classes-19",
  "level": "2",
  "url": "sec-groupe-des-classes.html#sec-groupe-des-classes-19",
  "type": "Remarque",
  "number": "3.4.7",
  "title": "",
  "body": " Les corps de nombres de nombre de classe , c-à-d ceux pour lesquels , restent très mystérieux. Le théorème de Stark-Heegner énonce que si est sans facteur carré, alors est de nombre de classe si, et seulement si   Une conjecture de Gauss, toujours ouverte, stipule qu'il existe une infinité de sans facteur carré tel que ait nombre de classe   Plus modestement, on ne sait même pas s'il existe une infinité de corps de nombres de nombre de classe . Celui de plus grand degré observé ayant cette propriété est de degré (voir l'article de ).  "
},
{
  ...
  "number": "3.4.8",
  "title": "",
  "body": "  Soit un corps de nombres. Alors tout idéal non nul de est inversible; autrement dit, est un groupe abélien fini.   "
},
{
  "id": "sec-groupe-des-classes-21",
  "level": "2",
  "url": "sec-groupe-des-classes.html#sec-groupe-des-classes-21",
  "type": "Démonstration",
  "number": "3.4.4",
  "title": "",
  "body": " On commence par montrer que la multiplication des idéaux est simplifiable dans un sens faible :    Si sont deux idéaux non nuls de tels que pour un certain , alors .     Nous allons d'abord montrer comment ramener le problème au cas où .  Pour cela, montrons que . Soit , de sorte que .On sait que est un -module libre de rang fini, et si l'on fixe une base de , alors l'élément agit par multiplication sur cette base comme une matrice à coefficients entiers. Par Cayley-Hamilton, le polynôme caractéristique de cette matrice annule , et comme ses coefficients sont entiers, on en déduit que . Par conséquent, .  Soit alors . On a alors , et le lemme de Nakayama ( e.g.  ) permet de conclure que , soit .   Soit un idéal non nul de . Pour montrer qu'il est inversible, il suffit de montrer qu'il existe un entier tel que est principal (car alors la classe de est l'inverse de la classe de ). Comme est fini, il existe deux entiers tels que . Il existe alors des éléments tels que et donc . En appliquant le , on trouve puis que est principal d'après la .  "
},
{
  "id": "cor-contenir-cest-diviser",
  "level": "2",
  "url": "sec-groupe-des-classes.html#cor-contenir-cest-diviser",
  "type": "Corollaire",
  "number": "3.4.10",
  "title": "",
  "body": "  Soient trois idéaux non nuls de .    (Simplification) Si , alors .    (Contenir c'est diviser) Si , alors il existe un idéal tel que .     "
},
{
  "id": "sec-groupe-des-classes-23",
  "level": "2",
  "url": "sec-groupe-des-classes.html#sec-groupe-des-classes-23",
  "type": "Démonstration",
  "number": "3.4.5",
  "title": "",
  "body": " Pour démontrer la simplification, prenons un idéal de tel que soit un principal, mettons (l'existence de est assurée par le ). Alors   soit : , à savoir .  De même, soit et tels que . Posons . C'est bien un idéal de car . On vérifie alors que .  "
},
{
  "id": "sec-Dedekind",
  "level": "1",
  "url": "sec-Dedekind.html",
  "type": "Section",
  "number": "4.1",
  "title": "<span class=\"process-math\">\\(\\mathcal{O}_K\\)<\/span> est de Dedekind",
  "body": " est de Dedekind   Produits d'idéaux premier  Soit un corps de nombres. Très souvent, l'anneau n'est pas factoriel (typiquement, si n'est pas réduit à un élément). Il existe nénamoins une version faible de la factorisation en irréductible au niveau des idéaux de . Dans cette sections, nous allons montrer que les idéaux de se factorisent de manière unique en produits d'idéaux premiers.   Dedekind   Soit un idéal strict non nul de . Alors il existe des idéaux premiers On rappelle qu'un idéal d'un anneau est dit premier si, étant donné avec , implique . De manière équivalente, est premier si, et seulement si le quotient est intègre. Dans la situation où et si est un idéal non nul, alors est un anneau fini. Comme tout anneau fini intègre est un corps, les idéaux premiers non nuls de sont exactement ses idéaux maximaux.  de tels que . De plus, cette factorisation est unique à l'ordre près.     Démontrons l'existence de cette décomposition. Supposons par l'absurde qu'il existe un idéal strict non nul qui n'admet pas une telle décomposition, et choisissons-le de norme minimale. En particulier, n'est pas un idéal premier. Il est néanmoins inclus dans un idéal maximal , qui est lui-même premier. On a donc et, puisque contenir c'est diviser ( cf.  ), il existe un idéal strict tel que . Notons que n'admet pas non plus une telle décomposition (car, sinon, en posséderait une), et que la norme de est strictement inférieure à celle de ( cf.  ). C'est une contradiction avec le choix de .  Montrons à présent l'unicité. Si deux telles décompositions sont égales, , alors est en particulier inclus dans . Puisque est premier, il existe tel que On utilise ici que si sont deux idéaux tels que avec premier et , alors ; en effet, si et mais , alors puis par primalité de .  . Par conséquent, . En simplifiant par , on trouve . En répétant ce raisonnement, on trouve que les deux décompositions sont égales à l'ordre près.    Un anneau intégre et noethérien possédant cette propriété de factorisation des idéaux est appelé un anneau de Dedekind.   Les corollaires de ce théorème sont nombreux. On en déduit par exemple la multiplicativité de la norme des idéaux :    Soient deux idéaux non nuls de . Alors .     D'après le , il suffit de montrer que pour un idéal strict et un idéal premier. Comme , on a d'après le que . Il suffit donc de montrer que .  Notons que, par simplification et puisque est maximal, les seuls idéaux qui contiennent et contenus dans sont et . En particulier, si est un élément de qui n'est pas dans , alors . On dispose alors d'un morphisme de groupes abéliens surjectif :   de noyau égal à . Ce noyau est un idéal de qui contient , et donc égal à l'un ou l'autre car est maximal. Or, puisque , et donc . L'application ci-dessus se factorise alors en un isomorphisme . D'où .     Factoriser un nombre premier   Soit un nombre premier. L'idéal n'est en général pas premier. Nous présentons ici une méthode pour décomposer cet idéal en produit d'idéaux premiers dans le cas où est monogène.    Soit tel que . Soit la réduction de modulo . Soit un diviseur de . On note   où est un relevé de .     L'idéal ne dépend pas du relevé choisi. En effet, si est un autre relevé de , alors , et donc . Par conséquent, .   Ces idéaux sont les seuls idéaux de qui contiennent d'après la proposition suivante.    L'application induit une bijection entre les facteurs unitaires de et les idéaux de contenant . De plus,     divise si, et seulement si .    L'idéal est premier si, et seulement si est irréductible dans .    La norme de vaut .       Par hypothèse, on dispose de l'isomorphisme d'anneaux qui envoie la classe de sur . En réduisant modulo , on trouve alors un autre isomorphisme   Rappelons que si est un anneau et un idéal, alors les idéaux de sont en bijection avec ceux de contenant : à un idéal de contenant , on associe l'idéal de ; réciproquement, à un idéal , on associe l'image inverse par le morphisme quotient qui est un idéal de contenant . Notons que cette bijection préserve les anneaux quotients, c-à-d , et donc préserve la primalité et la maximalité.  Les facteurs unitaires de sont en bijection avec les idéaux de contenant , eux-mêmes en bijection avec les idéaux de . Par l'isomorphisme ci-dessus, ils sont eux-mêmes en bijection avec idéaux de qui sont enfin en bijection avec les idéaux de contenant . Il suffit de remarquer que la composition de ces bijections est donnée par . Cette application, par construction, préserve l'inclusion des idéaux, d'où le premier point, et la primalité, d'où le second point. Enfin, on a   d'où le troisième point.     Soit la décomposition de en facteurs unitaires irréductibles dans . Alors on a   qui correspond la décomposition en idéaux premiers de .     Si est un idéal premier qui apparaît dans la décomposition de , alors en particulier il contient et on déduit de la qu'il est de la forme . Par la propriété de Dedekind, on peut trouver des entiers tels que   Il reste à montrer que pour tout . Pour ce faire, on considère, pour , le sous-ensemble des ideaux de qui contiennent mais qui ne sont pas contenu dans si .  D'une part, la propriété de Dedekind assure que est formé des puissances de : . D'autre part, la assure que égale l'image des puissances de qui divisent , à savoir , par . On en déduit   et .    Cherchons les idéaux de contenant . Comme qui se réduit à modulo , on trouve    "
},
{
  "id": "thm-factorisation",
  "level": "2",
  "url": "sec-Dedekind.html#thm-factorisation",
  "type": "Théorème",
  "number": "4.1.1",
  "title": "Dedekind.",
  "body": " Dedekind   Soit un idéal strict non nul de . Alors il existe des idéaux premiers On rappelle qu'un idéal d'un anneau est dit premier si, étant donné avec , implique . De manière équivalente, est premier si, et seulement si le quotient est intègre. Dans la situation où et si est un idéal non nul, alors est un anneau fini. Comme tout anneau fini intègre est un corps, les idéaux premiers non nuls de sont exactement ses idéaux maximaux.  de tels que . De plus, cette factorisation est unique à l'ordre près.   "
},
{
  "id": "subsec-produits-dideaux-premiers-4",
  "level": "2",
  "url": "sec-Dedekind.html#subsec-produits-dideaux-premiers-4",
  "type": "Démonstration",
  "number": "4.1.1.1",
  "title": "",
  "body": " Démontrons l'existence de cette décomposition. Supposons par l'absurde qu'il existe un idéal strict non nul qui n'admet pas une telle décomposition, et choisissons-le de norme minimale. En particulier, n'est pas un idéal premier. Il est néanmoins inclus dans un idéal maximal , qui est lui-même premier. On a donc et, puisque contenir c'est diviser ( cf.  ), il existe un idéal strict tel que . Notons que n'admet pas non plus une telle décomposition (car, sinon, en posséderait une), et que la norme de est strictement inférieure à celle de ( cf.  ). C'est une contradiction avec le choix de .  Montrons à présent l'unicité. Si deux telles décompositions sont égales, , alors est en particulier inclus dans . Puisque est premier, il existe tel que On utilise ici que si sont deux idéaux tels que avec premier et , alors ; en effet, si et mais , alors puis par primalité de .  . Par conséquent, . En simplifiant par , on trouve . En répétant ce raisonnement, on trouve que les deux décompositions sont égales à l'ordre près.  "
},
{
  "id": "subsec-produits-dideaux-premiers-5",
  "level": "2",
  "url": "sec-Dedekind.html#subsec-produits-dideaux-premiers-5",
  "type": "Remarque",
  "number": "4.1.2",
  "title": "",
  "body": " Un anneau intégre et noethérien possédant cette propriété de factorisation des idéaux est appelé un anneau de Dedekind.  "
},
{
  "id": "cor-multiplicativite-norme",
  "level": "2",
  "url": "sec-Dedekind.html#cor-multiplicativite-norme",
  "type": "Corollaire",
  "number": "4.1.3",
  "title": "",
  "body": "  Soient deux idéaux non nuls de . Alors .   "
},
{
  "id": "subsec-produits-dideaux-premiers-8",
  "level": "2",
  "url": "sec-Dedekind.html#subsec-produits-dideaux-premiers-8",
  "type": "Démonstration",
  "number": "4.1.1.2",
  "title": "",
  "body": " D'après le , il suffit de montrer que pour un idéal strict et un idéal premier. Comme , on a d'après le que . Il suffit donc de montrer que .  Notons que, par simplification et puisque est maximal, les seuls idéaux qui contiennent et contenus dans sont et . En particulier, si est un élément de qui n'est pas dans , alors . On dispose alors d'un morphisme de groupes abéliens surjectif :   de noyau égal à . Ce noyau est un idéal de qui contient , et donc égal à l'un ou l'autre car est maximal. Or, puisque , et donc . L'application ci-dessus se factorise alors en un isomorphisme . D'où .  "
},
{
  "id": "def-ideaux-I",
  "level": "2",
  "url": "sec-Dedekind.html#def-ideaux-I",
  "type": "Définition",
  "number": "4.1.4",
  "title": "",
  "body": "  Soit tel que . Soit la réduction de modulo . Soit un diviseur de . On note   où est un relevé de .   "
},
{
  "id": "sec-Dedekind-6",
  "level": "2",
  "url": "sec-Dedekind.html#sec-Dedekind-6",
  "type": "Remarque",
  "number": "4.1.5",
  "title": "",
  "body": " L'idéal ne dépend pas du relevé choisi. En effet, si est un autre relevé de , alors , et donc . Par conséquent, .  "
},
{
  "id": "prop-proprietes-I",
  "level": "2",
  "url": "sec-Dedekind.html#prop-proprietes-I",
  "type": "Proposition",
  "number": "4.1.6",
  "title": "",
  "body": "  L'application induit une bijection entre les facteurs unitaires de et les idéaux de contenant . De plus,     divise si, et seulement si .    L'idéal est premier si, et seulement si est irréductible dans .    La norme de vaut .     "
},
{
  "id": "sec-Dedekind-9",
  "level": "2",
  "url": "sec-Dedekind.html#sec-Dedekind-9",
  "type": "Démonstration",
  "number": "4.1.1",
  "title": "",
  "body": " Par hypothèse, on dispose de l'isomorphisme d'anneaux qui envoie la classe de sur . En réduisant modulo , on trouve alors un autre isomorphisme   Rappelons que si est un anneau et un idéal, alors les idéaux de sont en bijection avec ceux de contenant : à un idéal de contenant , on associe l'idéal de ; réciproquement, à un idéal , on associe l'image inverse par le morphisme quotient qui est un idéal de contenant . Notons que cette bijection préserve les anneaux quotients, c-à-d , et donc préserve la primalité et la maximalité.  Les facteurs unitaires de sont en bijection avec les idéaux de contenant , eux-mêmes en bijection avec les idéaux de . Par l'isomorphisme ci-dessus, ils sont eux-mêmes en bijection avec idéaux de qui sont enfin en bijection avec les idéaux de contenant . Il suffit de remarquer que la composition de ces bijections est donnée par . Cette application, par construction, préserve l'inclusion des idéaux, d'où le premier point, et la primalité, d'où le second point. Enfin, on a   d'où le troisième point.  "
},
{
  "id": "thm-factorisation-de-p",
  "level": "2",
  "url": "sec-Dedekind.html#thm-factorisation-de-p",
  "type": "Théorème",
  "number": "4.1.7",
  "title": "",
  "body": "  Soit la décomposition de en facteurs unitaires irréductibles dans . Alors on a   qui correspond la décomposition en idéaux premiers de .   "
},
{
  "id": "sec-Dedekind-11",
  "level": "2",
  "url": "sec-Dedekind.html#sec-Dedekind-11",
  "type": "Démonstration",
  "number": "4.1.2",
  "title": "",
  "body": " Si est un idéal premier qui apparaît dans la décomposition de , alors en particulier il contient et on déduit de la qu'il est de la forme . Par la propriété de Dedekind, on peut trouver des entiers tels que   Il reste à montrer que pour tout . Pour ce faire, on considère, pour , le sous-ensemble des ideaux de qui contiennent mais qui ne sont pas contenu dans si .  D'une part, la propriété de Dedekind assure que est formé des puissances de : . D'autre part, la assure que égale l'image des puissances de qui divisent , à savoir , par . On en déduit   et .  "
},
{
  "id": "sec-Dedekind-12",
  "level": "2",
  "url": "sec-Dedekind.html#sec-Dedekind-12",
  "type": "Exemple",
  "number": "4.1.8",
  "title": "",
  "body": " Cherchons les idéaux de contenant . Comme qui se réduit à modulo , on trouve   "
},
{
  "id": "sec-application-a-la-determination-de-ClOK",
  "level": "1",
  "url": "sec-application-a-la-determination-de-ClOK.html",
  "type": "Section",
  "number": "4.2",
  "title": "Application à la détermination de <span class=\"process-math\">\\(\\mathrm{Cl}(\\mathcal{O}_K)\\)<\/span>",
  "body": " Application à la détermination de  Soit un corps de nombres. Nous donnons ici une méthode pour déterminer le groupe abélien fini dans le cas où est de la forme pour un entier algébrique .     On détermine les constantes de à savoir son degré  , son nombre de plongement complexes à conjugaison près  et son discriminant  .  Rappelons que ces données se lisent sur le polynôme minimal de :   Le degré coincide avec le degré de ,    Le nombre coincide aux nombres de facteurs irréductibles de degré dans la factorisation de vu dans (le nombre de facteurs linéaires correspond à ),    Le discriminant correspond au discriminant de .     Cela nous permet de déterminer l'entier , où est la constante de Minkowski.  On sait (d'après la preuve du ) que tout idéal non nul de est équivalent à un idéal contenant un entier .    D'après le , est engendré par les classes des idéaux premiers. Pour il suffit donc de déterminer les idéaux premiers contenant et, puisque ceux-ci contiennent nécessairement un diviseur premier de , il suffit de déterminer les idéaux premiers de contenant un nombre premier .  Soit un nombre premier . Soit la réduction modulo du polynôme minimal de . Les idéaux premiers contenant ont été décrits par la : il s'agit des où est un facteur unitaire irréductible de .  On dispose alors d'un ensemble de générateurs du groupe , à savoir l'ensemble formé des classes où est un nombre premier et un facteur unitaire irréductible de .    Il nous reste à déterminer les relations entre ces générateurs; c'est en général l'étape qui nécessite plus d'ingéniosité. Par exemple, le en donne une :   si se factorise en irréductibles comme .  La méthode dite des éléments de petite norme suggère de chercher des éléments dont la norme est supportée aux premiers , puis de chercher la factorisation de l'idéal principal en produit d'idéaux premiers : si est de norme supportée en un ensemble de premiers , alors les idéaux premiers qui apparaissent dans la factorisation de sont les . En particulier, les ideaux premiers qui apparaissent en facteurs sont dans l'ensemble de générateurs précédemment construit et on trouve ainsi une nouvelle relation.      Pour ,  Comme est sans facteur carré et est , on a d'après le :   C'est bien un anneau d'entiers monogène, on peut donc appliquer la recette précédente pour déterminer son groupe des classes.     En première étape, on calcule les constantes de . On trouve alors , et , puis     Le groupe est donc engendré par les idéaux premiers de qui contiennent ou .  Soit de polynôme minimal .  Comme , les idéaux premiers de contenant sont   et ceux contenant sont   On notera leur classe , , et . On a donc trouvé un ensemble de générateurs du groupe , à savoir :     Reste à déterminer leurs relations. Comme et d'après le , on trouve   En particulier, est l'inverse de , et de même est l'inverse de . On a donc réduit l'ensemble de générateurs à .  Pour déterminer les relations entre et , on constate par exemple que . Comme et (mais , car sinon on aurait ce qui contredirait , et de même pour ), la factorisation de l'idéal en idéaux premiers est de la forme . En considérant les normes, on trouve et . D'où une nouvelle relation   On a alors réduit notre ensemble de générateur au singleton .  Il reste enfin à déterminer l'ordre de . Pour cela, on constate que . En général, se calcule par la forme quadratique   Comme est supporté en l'idéal premier (si , alors et donc ce qui est une contradiction !), en comparant les normes on trouve , soit   Ainsi l'ordre de vaut ou mais, comme n'est pas principal (sinon il y aurait un élément de norme , ce que l'on exclut en montrant que l'équation n'a pas de solution), l'ordre de est .     Ainsi, la classe de engendre et l'on trouve :    "
},
{
  "id": "sec-application-a-la-determination-de-ClOK-4",
  "level": "2",
  "url": "sec-application-a-la-determination-de-ClOK.html#sec-application-a-la-determination-de-ClOK-4",
  "type": "Exemple",
  "number": "4.2.1",
...
},
{
  "id": "fact-resolution",
  "level": "2",
  "url": "ch-factorization-of-ideals-4.html#fact-resolution",
  "type": "Fait",
  "number": "4.3.3",
  "title": "",
  "body": "   est de la forme pour . De plus,    "
},
{
  "id": "ch-factorization-of-ideals-4-20",
  "level": "2",
  "url": "ch-factorization-of-ideals-4.html#ch-factorization-of-ideals-4-20",
  "type": "Démonstration",
  "number": "4.3.2",
  "title": "",
  "body": " On a montré que est un cube dans . Soient donc tels que . On développe :   En comparant les secondes coordonnées dans la base , on trouve puis et . est donc de la forme indiquée.  On trouve alors ainsi que et enfin La fonction est une bijection de .  . On en déduit ainsi les deux seules solutions à l'équation de Mordell :   "
},
{
  "id": "ch-factorization-of-ideals-4-22",
  "level": "2",
  "url": "ch-factorization-of-ideals-4.html#ch-factorization-of-ideals-4-22",
  "type": "Remarque",
  "number": "4.3.4",
  "title": "L’équation de Fermat <span class=\"process-math\">\\(z^p=x^p+y^p\\)<\/span>.",
  "body": " L'équation de Fermat  Ces mêmes techniques ont permis à Kummer de résoudre certains cas du dernier théorème de Fermat. Si est un nombre premier et est une solution de l'équation , alors on dispose de la factorsation suivante dans le ième corps cyclotomique   Cette première étape est similaire à la factorisation de l'équation de Mordell que nous avons exploitée plus haut. Sous l'hypothèse que ne divise pas - un tel est appelé nombre premier régulier - on peut alors espérer pouvoir trouver une contradiction. C'est ce que démontrer Kummer en 1850 (mais la démonstration de Kummer ne rentre pas non plus dans la marge de ce cours...).  Les nombres premiers réguliers sont et . Si l'on sait qu'il en existe une infinité, on ignore toujours s'il existe une infinité de nombres premiers qui ne sont pas réguliers.  "
},
{
...
},
{
  "id": "sec-regulateur",
  "level": "1",
  "url": "sec-regulateur.html",
  "type": "Section",
  "number": "5.2",
  "title": "Régulateur des corps quadratiques réels",
  "body": " Régulateur des corps quadratiques réels  Dans la section précédente, nous avons démontré que est un réseau de l'hyperplan d'équation . Cet hyperplan admet un autre réseau, à savoir celui des points à coordonnées entières . Le régulateur de est alors défini comme le rapport entre les covolumes de ces deux réseaux :   Régulateur   Le régulateur de est le nombre réel positif .    Soit . Le régulateur de se calcule ainsi : on connaît déjà une base de , à savoir avec . Du côté unités, on fixe une famille de telle que soit une base de . Alors le régulateur de est égal à la valeur absolue du déterminant de la matrice avec où en fonction de si est réel ou complexe.  L'enjeu du calcul du régulateur réside donc dans la détermination d'une base de (modulo torsion). Nous allons montrer comment procéder dans le cas des corps quadratiques réels.  Soit un corps quadratique réel, où est un entier positif sans facteur carré. Les seules racines de l'unité dans sont et et, comme , le théorème des unités de Dirichlet assure que . En particulier, il existe une unité fondamentale telle que . Le régulateur de est alors égal à où désigne l'un des deux plongements réels de . Pour déterminer des unités fondamentales , on a la proposition suivante :    Soit une solution de l'équation de Pell-Fermat   Si est tel que est minimal pour cette propriété, alors est une unité fondamentale de .     Soit telle que et minimal pour cette propriété. On prétend que est une unité fondamentale. Pour le démontrer, soit . Quitte à remplacer pour son opposé, on peut supposer que et quitte à le remplacer par son inverse on peut supposer . Comme la suite est strictent décroissante de limite nulle, il existe tel que , puis par minimalité. En choisissant minimal pour cette propriété, on a aussi , soit . En particulier, puis .  On considère l'application   Cette application est bien définie : on vérifiera que est dans -- quelque soit la congruence de mod -- car et ont la même parité et que . Elle est injective, mais aussi surjective : si est une unité , avec , l'équation est satisfaite et est équivalente à solution de Pell-Fermat; reste à montrer que . L'inverse de vérifie .    Si , alors et donc , soit , puis .    Si , alors et donc , soit , puis .    Enfin, vérifions que est croissante : si et sont tels que et , alors il est clair que .    Régulateur de quelques corps quadratiques réels  Soit . L'équation de Pell-Fermat associée est . La plus petite solution entière de cette équation est . En conséquence, une unité fondamentale de est . Le régulateur de est alors égal à .  Soit . L'équation de Pell-Fermat associée est . La plus petite solution de cette équation est . En conséquence, une unité fondamentale de est . Le régulateur de est alors égal à .  Soit . L'équation de Pell-Fermat associée est . La plus petite solution entière de cette équation est . En conséquence, une unité fondamentale de est . Le régulateur de est alors égal à .   "
},
{
  "id": "def-regulateur",
  "level": "2",
  "url": "sec-regulateur.html#def-regulateur",
  "type": "Définition",
  "number": "5.2.1",
  "title": "Régulateur.",
  "body": " Régulateur   Le régulateur de est le nombre réel positif .   "
},
{
  "id": "prop-unite-fondamentale-quadratique-reel",
  "level": "2",
  "url": "sec-regulateur.html#prop-unite-fondamentale-quadratique-reel",
  "type": "Proposition",
  "number": "5.2.2",
  "title": "",
  "body": "  Soit une solution de l'équation de Pell-Fermat   Si est tel que est minimal pour cette propriété, alors est une unité fondamentale de .   "
},
{
  "id": "sec-regulateur-8",
  "level": "2",
  "url": "sec-regulateur.html#sec-regulateur-8",
  "type": "Démonstration",
  "number": "5.2.1",
  "title": "",
  "body": " Soit telle que et minimal pour cette propriété. On prétend que est une unité fondamentale. Pour le démontrer, soit . Quitte à remplacer pour son opposé, on peut supposer que et quitte à le remplacer par son inverse on peut supposer . Comme la suite est strictent décroissante de limite nulle, il existe tel que , puis par minimalité. En choisissant minimal pour cette propriété, on a aussi , soit . En particulier, puis .  On considère l'application   Cette application est bien définie : on vérifiera que est dans -- quelque soit la congruence de mod -- car et ont la même parité et que . Elle est injective, mais aussi surjective : si est une unité , avec , l'équation est satisfaite et est équivalente à solution de Pell-Fermat; reste à montrer que . L'inverse de vérifie .    Si , alors et donc , soit , puis .    Si , alors et donc , soit , puis .    Enfin, vérifions que est croissante : si et sont tels que et , alors il est clair que .  "
},
{
  "id": "sec-regulateur-9",
  "level": "2",
  "url": "sec-regulateur.html#sec-regulateur-9",
  "type": "Exemple",
  "number": "5.2.3",
  "title": "Régulateur de quelques corps quadratiques réels.",
  "body": " Régulateur de quelques corps quadratiques réels  Soit . L'équation de Pell-Fermat associée est . La plus petite solution entière de cette équation est . En conséquence, une unité fondamentale de est . Le régulateur de est alors égal à .  Soit . L'équation de Pell-Fermat associée est . La plus petite solution de cette équation est . En conséquence, une unité fondamentale de est . Le régulateur de est alors égal à .  Soit . L'équation de Pell-Fermat associée est . La plus petite solution entière de cette équation est . En conséquence, une unité fondamentale de est . Le régulateur de est alors égal à .  "
},
{
  "id": "sec-zeta-dedekind",
  "level": "1",
  "url": "sec-zeta-dedekind.html",
  "type": "Section",
  "number": "5.3",
  "title": "Fonction zêta de Dedekind",
  "body": " Fonction zêta de Dedekind  Soit un corps de nombres. La fonction zêta de Dedekind de en est la série   où la somme porte sur les idéaux non nuls de et est une nombre complexe de partie réelle . La convergence sera démontrée plus bas, mais rappelons d'ores et déjà le critère de convergence des séries de Dirichlet.   Convergence des séries de Dirichlet  Soit une suite de nombres complexes. Si les sommes partielles sont pour un nombre réel , alors la série de Dirichlet correspondante   converge vers une fonction holomorphe sur le demi-plan .    Formule du nombre de classes   La fonction s'étend méromorphiquement au demi-plan avec un pôle simple en . Son résidu se calcule par la formule :   où est le nombre de classes de , son régulateur, désigne le nombre de racines de l'unité de et son discriminant.     On doit le théorème ci-dessus à Dirichlet dans le cas des corps quadratiques. Hecke a en fait démontré que s'étend méromorphiquement à l'ensemble du plan complexe, avec un unique pôle simple en . Hecke a également démontré l'équation fonctionnelle : si est la fonction zêta dite complète ,où et , alors    Si le est accessible au niveau de ce cours, nous nous contenterons de le démontrer dans le cas où est un corps quadratique imaginaire.   Preuve de la formule du nombre de classes pour les corps quadratiques imaginaires  Soit un corps quadratique imaginaire, où est un entier négatif sans facteur carré. On interprète alors et ses idéaux comme des réseaux de vu comme -espace vectoriel de dimension . De plus , et donc . En particulier, .  Soit une classe de et désignons par le nombre de idéaux de norme dans la classe . En partitionant les ideaux selon leur classe dans , on trouve :   Le prolongement de la série ainsi que le calcule de son résidu découlent alors de l'estimation suivante :   En effet, en posant , en sommant sur les classes de on obtiendrait   avec . Comme la série converge uniformément sur le domaine d'après la et que , le théorème s'en déduit.  Démontrer l'estimation revient à compter les idéaux de norme donnée dans une classe donnée. Le lemme suivant permet de se ramener au comptage d'idéaux principaux.    Soit et un idéal de dans la classe inverse de . L'application induit une bijection entre les idéaux de norme dans la classe et les idéaux principaux inclus dans de norme .     L'application est bien définie car, pour dans la classe , et donc est principal ( c.f.  ). Que soit de norme si est de norme découle de la multiplicativté de la norme ( c.f.  ). Elle est injective par simplification ( c.f.  ). Enfin, elle est aussi surjective : si désigne un idéal principal de norme , alors comme contenir c'est diviser ( c.f.  ) il existe tel que . Comme est principal, on trouve que ; par multiplicativité de la norme, .   Démontrons enfin l'estimation . Soit un idéal dans la classe . D'après le lemme précédent, la quantité est égale à au nombre d'idéaux principaux inclus dans de norme . Il revient au même de compter les générateurs à unités près - c-à-d à près - à savoir les dans la boule de centre et de rayon . On trouve alors   On déduit alors du démontré en appendice (dans les notations du lemme, et donc ).    Produits eulériens  Puisque la norme est multiplicative, la fonction zêta de Dedekind admet un produit eulérien indéxé sur les idéaux premiers de :   La convergence de ce produit vaut aussi pour . Le produit eulérien de permet, pour certains corps de nombres , de la décomposer en produit de fonctions de Dirichlet. Nous allons expliquer ce phénomène dans le cas où est une extension quadratique.  Soit un entier sans facteur carré et . On rappelle que si est un nombre premier impair, le symbole de Legendre est égal à si divise , à si est un carré modulo , et à sinon. Lorsque , on définit plutôt   Enfin, suivant Kronecker, on étend la notation multiplicativement par si est la décomposition en facteurs premiers de .  Le symbole de Kronecker reflète la décomposition des nombres premiers dans .    Soit un nombre premier. Alors :    ( Cas inerte ) est premier dans si et seulement si ,    ( Cas décomposé ) avec premiers de si et seulement si ,    ( Cas ramifié ) avec premier de si et seulement si .       Soit tel que et soit son polynôme minimal. Son discriminant est égale à .  L'idéal est égal à et la décomposition de dépend de celle du polynôme modulo . Si , alors la relation donne :     est irréductible modulo si et seulement si n'est pas un carré modulo ,     est scindé à racines distinctes modulo si et seulement si est un carré non nul modulo ,     est scindé à racines doubles modulo si et seulement si .    Cela conclut le cas impair. Le cas se traite à la main : les polynômes de degré dans sont    L'unique polynôme irréductible est , de discriminant ,    L'unique polynôme scindé à racines disctinctes , de discriminant ,    Les deux polynômes à racines doubles et , de discriminant respectifs et .    On conclut en comparant avec .   On en déduit le corollaire suivant qui exprime la fonction zêta de en termes de séries de Dirichlet.        On prend comme point de départ le produit eulérien de et on le partitionne selon les trois types de nombres premiers. On trouve :   en utilisant les produits eulériens de et de .    Si est un caractère de Dirichlet réel modulo impair ( c-à-d  ), alors il existe une formule close pour :   Combiné à la formule du nombre de classes, cela permet de calculer le cardinal du groupe de classes lorsque est un corps quadratique imaginaire de discriminant . On a alors :     "
},
{
  "id": "rem-convergence-series-dirichlet",
  "level": "2",
  "url": "sec-zeta-dedekind.html#rem-convergence-series-dirichlet",
  "type": "Remarque",
  "number": "5.3.1",
  "title": "Convergence des séries de Dirichlet.",
  "body": " Convergence des séries de Dirichlet  Soit une suite de nombres complexes. Si les sommes partielles sont pour un nombre réel , alors la série de Dirichlet correspondante   converge vers une fonction holomorphe sur le demi-plan .  "
},
{
  "id": "thm-formule-nombre-classes",
  "level": "2",
  "url": "sec-zeta-dedekind.html#thm-formule-nombre-classes",
  "type": "Théorème",
  "number": "5.3.2",
  "title": "Formule du nombre de classes.",
  "body": " Formule du nombre de classes   La fonction s'étend méromorphiquement au demi-plan avec un pôle simple en . Son résidu se calcule par la formule :   où est le nombre de classes de , son régulateur, désigne le nombre de racines de l'unité de et son discriminant.   "
},
{
  "id": "rem-equation-fonctionnelle-zeta-dedekind",
  "level": "2",
  "url": "sec-zeta-dedekind.html#rem-equation-fonctionnelle-zeta-dedekind",
  "type": "Remarque",
  "number": "5.3.3",
  "title": "",
  "body": " On doit le théorème ci-dessus à Dirichlet dans le cas des corps quadratiques. Hecke a en fait démontré que s'étend méromorphiquement à l'ensemble du plan complexe, avec un unique pôle simple en . Hecke a également démontré l'équation fonctionnelle : si est la fonction zêta dite complète ,où et , alors   "
},
{
  "id": "sec-zeta-dedekind-9",
  "level": "2",
  "url": "sec-zeta-dedekind.html#sec-zeta-dedekind-9",
  "type": "Démonstration",
  "number": "5.3.1",
...
},
{
  ...
  "level": "2",
  "url": "sec-zeta-dedekind.html#prop-decomposition-Kronecker",
  "type": "Proposition",
  "number": "5.3.5",
  "title": "",
  "body": "  Soit un nombre premier. Alors :    ( Cas inerte ) est premier dans si et seulement si ,    ( Cas décomposé ) avec premiers de si et seulement si ,    ( Cas ramifié ) avec premier de si et seulement si .     "
},
{
  "id": "subsec--10",
  "level": "2",
  "url": "sec-zeta-dedekind.html#subsec--10",
  "type": "Démonstration",
  "number": "5.3.1.1",
  "title": "",
  "body": " Soit tel que et soit son polynôme minimal. Son discriminant est égale à .  L'idéal est égal à et la décomposition de dépend de celle du polynôme modulo . Si , alors la relation donne :     est irréductible modulo si et seulement si n'est pas un carré modulo ,     est scindé à racines distinctes modulo si et seulement si est un carré non nul modulo ,     est scindé à racines doubles modulo si et seulement si .    Cela conclut le cas impair. Le cas se traite à la main : les polynômes de degré dans sont    L'unique polynôme irréductible est , de discriminant ,    L'unique polynôme scindé à racines disctinctes , de discriminant ,    Les deux polynômes à racines doubles et , de discriminant respectifs et .    On conclut en comparant avec .  "
},
{
  "id": "cor-",
  "level": "2",
  "url": "sec-zeta-dedekind.html#cor-",
  "type": "Corollaire",
  "number": "5.3.6",
  "title": "",
  "body": "    "
},
{
  "id": "subsec--13",
  "level": "2",
  "url": "sec-zeta-dedekind.html#subsec--13",
  "type": "Démonstration",
  "number": "5.3.1.2",
  "title": "",
  "body": " On prend comme point de départ le produit eulérien de et on le partitionne selon les trois types de nombres premiers. On trouve :   en utilisant les produits eulériens de et de .  "
},
{
  "id": "subsec--14",
  "level": "2",
  "url": "sec-zeta-dedekind.html#subsec--14",
  "type": "Remarque",
  "number": "5.3.7",
  "title": "",
  "body": " Si est un caractère de Dirichlet réel modulo impair ( c-à-d  ), alors il existe une formule close pour :   Combiné à la formule du nombre de classes, cela permet de calculer le cardinal du groupe de classes lorsque est un corps quadratique imaginaire de discriminant . On a alors :   "
},
{
...
},
{
  ...
  "body": " Rappels sur les anneaux  Nous rappelons ici quelques définitions et résultats de base sur les anneaux commutatifs avec unité qui seront utilisés dans ce cours.   Nakayama   Soit un -module libre de rang fini non nul et un idéal de tel que . Alors .     Soit une base de . Puisque , on peut écrire chaque comme une combinaison linéaire à coefficients dans des éléments de la base, c'est-à-dire :   En particulier, l'identité agit comme la matrice et donc . Ainsi .   "
},
{
  "id": "lem-nakayama",
  "level": "2",
  "url": "sec-rappels-sur-les-anneaux.html#lem-nakayama",
  "type": "Lemme",
  "number": "A.2.1",
  "title": "Nakayama.",
  "body": " Nakayama   Soit un -module libre de rang fini non nul et un idéal de tel que . Alors .   "
},
{
  "id": "sec-rappels-sur-les-anneaux-4",
  "level": "2",
  "url": "sec-rappels-sur-les-anneaux.html#sec-rappels-sur-les-anneaux-4",
  "type": "Démonstration",
  "number": "A.2.1",
  "title": "",
  "body": " Soit une base de . Puisque , on peut écrire chaque comme une combinaison linéaire à coefficients dans des éléments de la base, c'est-à-dire :   En particulier, l'identité agit comme la matrice et donc . Ainsi .  "
},
{
  "id": "sec-reseaux",
  "level": "1",
...
},
{
  ...
  "body": " Covolume d'un réseau   Soient et deux réseaux de . On appelle covolume de relativement à le nombre où est la matrice d'une base de écrite dans une base de . On le note , ou encore .   On notera que est bien indépendant du choix des bases de et , car des choix différents donnerait une matrice de passage de la forme où .    "
},
{
  "id": "subsec-structure-des-reseaux-14",
  "level": "2",
  "url": "sec-reseaux.html#subsec-structure-des-reseaux-14",
  "type": "Remarque",
  "number": "A.3.7",
  "title": "",
  "body": " Lorsqu'une base de est fixée, on notera aussi au lieu de .  "
},
{
  ...
  "number": "A.3.8",
  "title": "",
  "body": "  Soit une inclusion de réseaux. Alors    "
},
{
  "id": "subsec-structure-des-reseaux-19",
  "level": "2",
  "url": "sec-reseaux.html#subsec-structure-des-reseaux-19",
  "type": "Démonstration",
  "number": "A.3.1.2",
  "title": "",
...
{
  "id": "subsec-structure-des-reseaux-20",
  "level": "2",
  "url": "sec-reseaux.html#subsec-structure-des-reseaux-20",
  "type": "Exemple",
  "number": "A.3.9",
  "title": "Calcul de covolume.",
  "body": " Calcul de covolume  On peut utiliser la proposition précédente pourcalculer le covolume du réseau de relativement au réseau sans avoir à en trouver une base. En effet, s'identifie au noyau de l'application surjective   On a donc et, par la , on en déduit que .  On peut maintenant en déduire une base : les vecteurs et sont dans et   Par minimalité du covolume, est une base de .  "
},
{
...
},
{
  ...
  "number": "A.3.3.1",
  "title": "",
  "body": " On commence par un lemme classique du à Euler.    Si , alors est un carré modulo .     En particulier, est impair. On considère le polynôme dans qui admet au plus racines. Par Fermat, annule tous les carrés de , et il y en a exactement : pour le voir, on peut utiliser l'isomorphisme obtenu en considérant le morphisme surjectif de vers ses carrés et de noyau .  On en déduit que les racines de sont exactement les carrés de . Comme , on a que est racine de , donc est un carré dans .   Soit donc une racine de modulo . On considère le réseau de    C'est un réseau de covolume : en effet, s'identifie au noyau du morphisme surjectif   et donc , puis d'après la .  De plus, pour tout , on a .  On considère la boule ouverte de rayon ; c'est un ouvert convexe et symétrique de mesure  . Le lemme du corps convexe assure qu'il existe non nul. Un tel couple vérifie et . On en déduit .  "
},
{
  "id": "thm-lagrange",
  "level": "2",
...
{
  "id": "lem-comptage-points",
  "level": "2",
  "url": "sec-reseaux.html#lem-comptage-points",
  "type": "Lemme",
  "number": "A.3.18",
  "title": "",
  "body": "  Soit une norme sur et la boule de rayon pour cette norme. Soit et sa dérivée. Alors    "
},
{
  "id": "subsec-comptage-points-5",
  "level": "2",
  "url": "sec-reseaux.html#subsec-comptage-points-5",
  "type": "Démonstration",
  "number": "A.3.4.1",
  "title": "",
  "body": " Soit un pavé fondamental de et soit tel que (inclusion stricte). Soit l'ensemble des tels que ; comme est compacte et que , l'ensemble est fini et on note son cardinal. Les inclusions :   donnent ainsi que . Ces inégalités combinées impliquent   Cela conclut, en remarquant que, comme est à croissance polynomiale, on a .  "
},
{
  "id": "references",
  "level": "1",
